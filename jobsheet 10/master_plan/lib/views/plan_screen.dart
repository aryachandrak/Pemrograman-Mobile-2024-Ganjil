...
class _PlanScreenState extends State<PlanScreen> {
      ...
      leading: Checkbox(
        ...
        onChanged: (selected) {
          ...
          if (planIndex >= 0) {
            ...
            List<Task> updatedTasks = List<Task>.from(currentPlan.task);
  ...
  Widget _buildList(Plan currentPlan) {
    return ListView.builder(
      ...
      itemCount: currentPlan.task.length,
      itemBuilder: (context, index) =>
          _buildTaskTile(currentPlan.task[index], index, context, currentPlan),
    );
  }
